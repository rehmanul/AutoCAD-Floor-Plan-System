...
public:
    ...
    /// <summary>
    /// This will return EXIF orientation of the image.
    /// </summary>
    ///
    /// <returns>
    /// An entry of the <c>Atil::Orientation</c> enum describing the one of eight
    /// possible EXIF orientations that will be applied to the image as it is loaded.
    /// </returns>
    ///
    Atil::Orientation EXIFOrientation() const;
