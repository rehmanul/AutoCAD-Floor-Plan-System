...
public:
    ...
    ///<summary>This queuries the EXIF orientation that the data will be returned in.</summary>
    ///<returns>This returns a member of the <c>Atil::Orientation</c> enum describing the EXIF orientation.</returns>
    ///<remarks> Not all image types have EXIF orientation data <c>kTopDownLeftRight</c> will return as default EXIF orientation</remarks>
    virtual Atil::Orientation EXIFOrientation()
    {
        return kTopDownLeftRight;
    }
